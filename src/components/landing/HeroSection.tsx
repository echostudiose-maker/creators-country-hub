    ...
    <section className="relative min-h-screen bg-section-light text-section-light-text overflow-hidden">
      <div className="grid lg:grid-cols-2 min-h-screen">
        ...
        <div className="relative min-h-[60vh] lg:min-h-screen flex items-center justify-center lg:justify-start px-6 lg:px-0">
          ...
          >
            {/* Story Card */}
            <div className="relative w-[280px] md:w-[340px] lg:w-[380px] aspect-[9/16] rounded-[1.5rem] overflow-hidden bg-background shadow-2xl shadow-section-light-text/15">
              {/* Story Image - full authentic screenshot (no crop) */}
              <img
                src={bahStoryClean}
