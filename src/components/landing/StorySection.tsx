...
const StorySection = () => (
  <section className="section-light py-16 md:py-28 border-t border-section-light-text/10 overflow-hidden">
    <div className="max-w-6xl mx-auto px-6 md:px-10">
      ...
      <div className="grid md:grid-cols-[1fr_1.1fr] gap-10 md:gap-20 items-start">
        <div>
          <motion.h2
            className="font-body font-semibold text-[clamp(2.4rem,8vw,5rem)] text-section-light-text leading-[0.9]"
        ...
        <motion.div className="space-y-5" initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          <p className="font-body text-section-light-text/72 text-lg leading-[1.75]">
          ...
          <p className="font-body text-section-light-text/72 text-lg leading-[1.75]">
            Em 90 dias, cresci mais de <strong className="text-section-light-text">90 mil seguidores</strong> e multipliquei meu faturamento em <strong className="text-section-light-text">5x</strong>.
          </p>
          <div className="rounded-2xl overflow-hidden aspect-[16/10]">
            <img src={bahEvent} alt="Bah em cobertura de evento" className="w-full h-full object-cover" loading="lazy" />
          </div>
          <p className="font-body text-section-light-text font-semibold text-lg">Agora você aplica esse sistema pronto no seu perfil.</p>
        </motion.div>
      </div>
    </div>
  </section>
